...
def init_browser():
    executable_path = {"executable_path": "C:\Users\Brendan Dowd\chromedriver_win32\chromedriver.exe"}
...
def scrape():
    ...
    #base urls
    hemisphere_base_url = "{0.scheme}://{0.netloc}/".format(urlsplit(url)url_hemisphere)
    hemisphere_img_urls = []
    hemisphere_img_urls

    #Cereberus hemisphere image url
    hemisphere_img_urls = []
    results = broswer.find_by_xpath( "//*[@id='wide-image-toggle']").click()
    time.sleep(2)
